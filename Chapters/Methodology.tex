...
The procedures remain the same than in the original game.
...
The hero can gain score by collecting the key, which gives to him 100 points.
He can also gain 10 points by passing through each of the checkpoints. %TODO QUE ANDERS RESPONDA A LO DE LAS OPTIONS
I have manually added the checkpoints to guide the agent towards the key.
