...
and exploration.
We refer to this new algorithm as \acf{MA3C} and in this section you will find specifications about the architectures of
both \acp{ANN}: \ac{A3C} and \ac{MA3C}.
In addition we will explain the \ac{MA3C} algorithm.

They have been developed using tensorflow (\cite{tensorflow2015}), an open source machine learning framework which we find %TODO evita dar opiniones, pon datos de papers mejor
really useful to implement deep learning algorithms.

\subsection{\acl{A3C}\label{subsec:AlgorithmA3C}}

As we have explained previously (\ffref{subsec:A3C}), this algorithm uses the image of the environment to represent the state.
...
We have also compared the algorithms in a real game, Montezuma's Revenge, which has become famous because of its difficulty.
